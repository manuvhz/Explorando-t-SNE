...
const GlossaryCard: React.FC<{ term: string, definition: string, delay: number }> = ({ term, definition, delay }) => (
    <div 
        className="bg-light-navy p-6 rounded-lg shadow-md hover:shadow-xl dark:hover:shadow-neon-turquoise/10 transition-all duration-300 transform hover:-translate-y-1 animate-fade-in-stagger"
