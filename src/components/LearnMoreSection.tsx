                ...
                {LEARN_MORE_LINKS.map(link => {
                    ...
                    return (
                        <a 
                            ...
                            className="flex items-center p-4 bg-light-navy rounded-lg shadow-md hover:shadow-lg hover:bg-light-navy/70 transition-all duration-300 transform hover:scale-105"
                        >
                            <IconComponent />
