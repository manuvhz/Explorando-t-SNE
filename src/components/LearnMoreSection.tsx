                ...
                {LEARN_MORE_LINKS.map(link => {
                    ...
                    return (
                        <a 
                            ...
                            className="flex items-center p-4 bg-slate-50 dark:bg-light-navy rounded-lg shadow-md hover:shadow-lg hover:bg-slate-100 dark:hover:bg-light-navy/70 transition-all duration-300 transform hover:scale-105"
                        >
                            <IconComponent />
                            <span className="text-slate-900 dark:text-light-slate font-medium">{link.name}</span>
                            <svg className="h-5 w-5 ml-auto text-slate-400 dark:text-dark-slate" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                        </a>
                    );
                })}
            </div>
